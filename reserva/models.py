...
class Hotel(models.Model):
    ...
    preco = models.DecimalField("Preço", max_digits=7, decimal_places=2, validators=[MinValueValidator(0.01)])
    notaAvaliacao = models.DecimalField("Nota de Avaliação", max_digits=3, decimal_places=2, validators=[MinValueValidator(0), MaxValueValidator(5)]) # De 0 a 5 -> ex: 4.5
    qualidadeWifi = models.DecimalField("Qualidade do WIFI", max_digits=3, decimal_places=2, validators=[MinValueValidator(0), MaxValueValidator(10)]) # De 0 a 10 -> ex: 8.9
